# Домашнее задание к занятию "6.4. PostgreSQL" - dev-17_subd_6.4.-yakovlev_vs
postgres
...
```bash
root@server1:~# docker run --rm --name postgres-srv -e POSTGRES_PASSWORD=postgres -p 5432:5432 -v vol_postgres:/var/lib/postgresql/data -d postgres:13
ffba031abfc927d08dff336f85e6b7a8c4f3afe2ae048996621b6c9db3564b71
root@server1:~# docker ps
CONTAINER ID   IMAGE         COMMAND                  CREATED         STATUS         PORTS                                       NAMES
ffba031abfc9   postgres:13   "docker-entrypoint.s…"   4 seconds ago   Up 2 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   postgres-srv
root@server1:~# docker exec -it postgres-srv bash
root@ffba031abfc9:/# psql -U postgres
...
-----------+----------+----------+------------+------------+-----------------------+---------+------------+----------------------------------------
----
 postgres  | postgres | UTF8     | en_US.utf8 | en_US.utf8 |                       | 7901 kB | pg_default | default administrative connection datab
ase
...
CREATE DATABASE
postgres=# \q
root@ffba031abfc9:/# psql -U postgres -f /var/lib/postgresql/data/test_dump.sql  test_database
SET
SET
SET
SET
...
```bash
root@ffba031abfc9:~# export PGPASSWORD=netology && pg_dump -h localhost -U postgres test_database > /tmp/test_database_dump.sql
root@ffba031abfc9:~# cd /tmp
root@ffba031abfc9:/tmp# ls -l
total 4
-rw-r--r-- 1 root root 3763 Aug  8 18:54 test_database_dump.sql
```
